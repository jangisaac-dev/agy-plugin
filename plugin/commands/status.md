---
description: List recent agy jobs (or show one) from .ai-runs/agy, including background job state
argument-hint: '[job-id]'
disable-model-invocation: true
allowed-tools: Bash(bash:*)
---

!`bash "${CLAUDE_PLUGIN_ROOT}/scripts/agy-run.sh" status "$ARGUMENTS"`
